...
ERPNext Connector Adapter — stub only, not wired into Milestone 1. Present so the Connector Interface's shape never needs rework when this adapter is built.

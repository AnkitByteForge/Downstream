...
Procore Connector Adapter — inbound webhook receipt, enrichment GET-back, and EngineeringEventEnvelope construction. Wired into Milestone 1, run against infra/mocks/mock-engineering-system.

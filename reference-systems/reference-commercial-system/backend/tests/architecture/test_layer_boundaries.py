...
# "Business rules must never depend on FastAPI/SQLAlchemy" as a checked
# fact, not a convention — mirrors the Reference Engineering System's own
# architecture test exactly (independent copy, per ADR-011's no-shared-code
# rule).
FORBIDDEN_IMPORTS = {
